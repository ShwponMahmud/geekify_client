    ...
    <>
      <div className="customer_speak_for_us_section">
        <div className="container mx-auto">
          <div className="customer_speak_for_us_heading_container">
          ...
          <div className="customer_speak_for_us_content_container my-5 grid grid-cols-3 gap-5 mt-28">
            <div className="customer_speak_content_card">
