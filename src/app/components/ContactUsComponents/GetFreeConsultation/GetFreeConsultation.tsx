  ...
  return (
    <>
      <div className="get_free_consultation_section">
        <h2 className="text-3xl lg:text-5xl font-bold mb-5 text-center md:text-left">
          Get a Free <span className="text-primaryColor">Consultation</span>
        </h2>
        <p className="text-deepGrayColor mb-5 text-center md:text-left">
          Our remote service solutions are designed to help you troubleshoot and
          fix tech issues from the comfort of your home or office. Experience
          quick and reliable support wherever you are.
        </p>
                    ...
                    {address && (
                      <div className="address_modify_container mt-4">
                        <h2 className="text-sm font-semibold mb-4 text-orange-400 flex items-center gap-1">
                          ...
                          Please modify the following address fields, if there
                          is anything wrong.
                        </h2>
