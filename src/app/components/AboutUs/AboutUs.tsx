        ...
        <div className='container mx-auto'>
          <div>
            <div className='grid grid-cols-1 md:grid-cols-2 items-center gap-10 xl:gap-28 py-8 md:py-14 lg:py-20 xl:py-28'>
              <div>
                <h3 className='text-3xl md:text-3xl lg:text-5xl font-semibold pb-4 md:pb-7'>The Geekify <span className='text-primaryColor'>Story</span></h3>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-16 xxl:gap-28 pb-10 md:pb-16 lg:pb-28'>
              ...
              <div>
                <h3 className='text-3xl md:text-3xl lg:text-5xl font-semibold pb-4 md:pb-7'>What <span className='text-primaryColor'>We’re About</span></h3>
            ...
            <div className='pb-10 md:pb-16 lg:pb-28'>
              <h3 className='text-3xl md:text-3xl lg:text-5xl font-semibold pb-4 md:pb-7'>How we approved by our customer</h3>
              <p className='lg:text-xl'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley 
