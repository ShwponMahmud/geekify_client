        ...
        <div className="container mx-auto justify-items-center">
          <div className="h-[70vh] grid content-center text-center">
            <div className="justify-items-center">
              ...
              <button onClick={bookingStartHandler} className="bg-primaryColor border border-primaryColor py-[10px] px-[20px] rounded-[7px] text-white mt-[40px] hover:bg-white hover:text-primaryColor transition-[.5s]">
                Start Booking
              </button>
            </div>
          </div>
