        ...
        <div className="bg-sectionBackgroundColor py-8 md:py-14 lg:py-20 xl:py-28">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-14">
              ...
              <Link href="/contact-us" className="py-[20px] border-[3px] hover:bg-primaryColor transition-[.5s] hover:text-white border-primaryColor text-primaryColor rounded-[50px] flex justify-center gap-2 items-center">
              ...
              <Link href="/booking-online" className="py-[20px] border-[3px] hover:bg-primaryColor transition-[.5s] hover:text-white border-primaryColor text-primaryColor rounded-[50px] flex justify-center gap-2 items-center">
