...
function RemoteSupportComponent() {
  return (
    <>
      <Showcase backgroundImage='/remote-support-banner.png' title='Geeks Remote' highlights='Services' paragraph='At Geekify, we would like to assure you that we will continue to provide unfaltering support and
        find ways to help you with your IT problems.'/>
      <div>
