        ...
        <div>
          <div className='bg-sectionBackgroundColor py-8 md:py-14 lg:py-20 xl:py-28'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-center container mx-auto'>
              <div>
                <h3 className='text-3xl md:text-3xl lg:text-5xl font-semibold pb-4 md:pb-7'>Few reasons why you should join our <span className='text-primaryColor'>amazing team</span></h3>
                <p>
          ...
          <div className='container mx-auto'>
            <div className='py-8 md:pt-14 lg:pt-20 xl:pt-28'>
              <div>
                <h5 className='text-3xl md:text-3xl lg:text-5xl font-semibold pb-4 md:pb-7 text-center'>Career Openings</h5>
