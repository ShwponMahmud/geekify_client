  ...
  return (
    <div>
        ...
        <div>
          ...
          <div>
            <p className='text-center'>Let’s talk about Create an Email for Business. In today’s world, having a professional email address is essential for any business. It facilitates communication and builds
              ...
              using a free email service like Gmail or Yahoo. If you're unsure how to get a business email or <a href="https://geekify.com.au/services/email-account-set-up" className='text-primaryColor underline'>set up a company email</a>, this guide will help. We'll cover everything from choosing the right domain,
      ...
      <div className='container mx-auto py-8 md:py-14 lg:py-20 xl:py-28'>
        ...
        <Image src={'/email-account-5.png'} alt='create an email for business' width={1200} height={900} className='w-full h-auto' />
        <div className='py-5'>
      ...
      <div className='container mx-auto'>
        ...
        <div className='flex items-center gap-7 border-t-[1px] border-[#EC5930] pb-7'>
          <div className='h-full hidden bg-gradient-to-l from-[#F93A22] to-[#FB9618] rounded-tr-[50px] rounded-br-[50px] p-7 lg:flex justify-center items-center'>
            <Image src='/email-account-icon-1.png' width={100} height={80} alt='' className='w-[65px] h-[55px]' />
          </div>
          <div className='pt-3 lg:pt-0'>
            <h5 className='font-bold pb-1'>1. Use Strong Passwords</h5>
            <p>
              As an email service provider encourage all employees to use complex passwords. That combines letters, numbers, and symbols. Avoid using easily guessable information like birthdays or common words.
            </p>
          </div>
        </div>
        <div className='flex items-center gap-7 border-t-[1px] border-[#F18E36] pb-7'>
          <div className='h-full bg-gradient-to-l from-[#FEA129] to-[#FCD44C] rounded-tr-[50px] rounded-br-[50px] p-7 hidden lg:flex justify-center items-center'>
            <Image src='/email-account-icon-2.png' width={100} height={80} alt='' className='w-[60px] h-[55px]' />
          </div>
          <div className='pt-3 lg:pt-0'>
            <h5 className='font-bold pb-1'>2. Enable Two-Factor Authentication (2FA)</h5>
            <p>
              Most professional email services offer two-factor authentication. That requires users to provide a second form of identification (like a text code) when logging in.
            </p>
          </div>
        </div>
        <div className='flex items-center gap-7 border-t-[1px] border-[#C3466E] pb-7'>
          <div className='h-full bg-gradient-to-l from-[#AB1F87] to-[#EC67A8] rounded-tr-[50px] rounded-br-[50px] p-7 hidden lg:flex justify-center items-center'>
            <Image src='/email-account-icon-3.png' width={100} height={80} alt='' className='w-[55px] h-[55px]' />
          </div>
          <div className='pt-3 lg:pt-0'>
            <h5 className='font-bold pb-1'>3. Educate Your Team</h5>
            <p>
              Train your employees to recognize phishing emails and avoid clicking on suspicious links or attachments. Cybercriminals often target businesses through email scams.
            </p>
          </div>
        </div>
        <div className='flex items-center gap-7 border-t-[1px] border-[#6450AA] pb-7'>
          <div className=' h-full bg-gradient-to-l from-[#443D98] to-[#A576B3] rounded-tr-[50px] rounded-br-[50px] p-7 hidden lg:flex justify-center items-center'>
            <Image src='/email-account-icon-4.png' width={100} height={80} alt='' className='w-[55px] h-[55px]' />
          </div>
          <div className='pt-3 lg:pt-0'>
            <h5 className='font-bold pb-1'>4. Regularly Update Software</h5>
            <p>
              Keep your email software and devices up-to-date with the latest security patches. This minimizes vulnerabilities that hackers could exploit.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className='container mx-auto py-8 md:py-14 lg:py-20 xl:py-28'>
        <h3 className='text-2xl md:text-2xl lg:text-4xl font-semibold pb-4 md:pb-7 text-center'>How to Get a<span className='text-primaryColor'> Company Email for Your Team</span></h3>
        <p className='mb-4 text-center pb-4'>
          As a business owner your business grows, you’ll likely need to create an email for your business and your employees. Having a company email system in place ensures smooth communication, professionalism,
          and brand consistency.
        </p>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          <div className='shadow-boxShadow rounded-2xl'>
            <h5 className='text-3xl font-bold pb-1 text-center pt-5'>Step 01</h5>
            <div className='py-5'>
              <Image src='/bend-line.png' width={600} height={300} alt='' className='w-full h-full' />
            </div>
            <p className='p-5'>
              Create an Email for Business and Employees: Use a consistent format like firstname@yourbusiness.com. This will make your email hosting plan easy to manage.
            </p>
          </div>
          <div className='shadow-boxShadow rounded-2xl'>
            <h5 className='text-3xl font-bold pb-1 text-center pt-5'>Step 02</h5>
            <div className='py-5'>
              <Image src='/bend-line.png' width={600} height={300} alt='' className='w-full h-full' />
            </div>
            <p className='p-5'>
              Set Up Aliases: Some email campaign services allow you to create aliases. What are alternate personalized email addresses? This delivers messages to a single inbox. This is useful if an employee
              has multiple roles within the company (support@yourbusiness.com).
            </p>
          </div>
          <div className='shadow-boxShadow rounded-2xl'>
            <h5 className='text-3xl font-bold pb-1 text-center pt-5'>Step 03</h5>
            <div className='py-5'>
              <Image src='/bend-line.png' width={600} height={300} alt='' className='w-full h-full' />
            </div>
            <p className='p-5'>
              Group Email Accounts: Set up group accounts for departments such as sales@yourbusiness.com or support@yourbusiness.com to manage customer inquiries more efficiently.
            </p>
          </div>
          <div className='shadow-boxShadow rounded-2xl'>
            <h5 className='text-3xl font-bold pb-1 text-center pt-5'>Step 04</h5>
            <div className='py-5'>
              <Image src='/bend-line.png' width={600} height={300} alt='' className='w-full h-full' />
            </div>
            <p className='p-5'>
              Train Employees: Make sure your team knows how to use the email system, including setting up their accounts on different devices and following best security practices.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className='container mx-auto py-8 md:py-14 lg:py-20 xl:py-28'>
        <h3 className='text-2xl lg:text-4xl font-bold pb-6 italic'>In The End Why You Should Create <span className='text-primaryColor'>An Email For Business</span>
        </h3>
        <p className='pb-5'>
          Creating an email for business or Apple Mail is an important step toward building a professional and trusted brand. With the right domain, reliable email hosting, incoming emails, email forwarding,
