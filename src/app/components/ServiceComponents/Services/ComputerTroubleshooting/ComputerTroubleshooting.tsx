  ...
  return (
    <div>
      ...
      <div className='container mx-auto py-8 md:py-14 lg:py-20 xl:py-28'>
        <div>
          ...
          <div className='pt-8 md:pt-14 lg:pt-20 xl:pt-28'>
            <h3 className='text-2xl md:text-2xl lg:text-4xl font-semibold pb-4 md:pb-7 text-center'>Our Computer <span className='text-primaryColor'>Services and Support</span></h3>
            <p className='text-center pb-5'>
              Our computer support services cover a wide range of computer-related issues. Whether you need computer fix solutions, monitor repair, laptop screen repairs, or PC troubleshooting, our technicians
              have the expertise to handle New York computer help. Here’s a breakdown of our core services:
            </p>

            <h5 className='text-2xl md:text-2xl lg:text-3xl font-semibold pb-4 pt-3 text-center'>Comprehensive Computer Services and Support</h5>
            ...
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row bg-white shadow-md rounded-2xl overflow-hidden">
                ...
                <div className="p-5 flex justify-center items-center">
                  <div>
                    <div className='flex'>
                      <h3 className="text-lg font-bold italic">Computer Fix and Tech Services:</h3>
                      <div className='w-[80px] border-b-[1px] border-primaryColor mb-[8px] ml-3'></div>
                    </div>
                    <p className="text-gray-600 mt-2">
                      From software issues to hardware malfunctions, our computer managed service includes everything you need to keep your system running smoothly. Our computer mechanics troubleshoot, repair, and
                      optimize your device. So you can get back to what matters most with tech support.
                    </p>
                  </div>
                </div>
              </div>
              <div className="flex flex-col md:flex-row-reverse bg-white shadow-md rounded-2xl overflow-hidden">
                ...
                <div className="p-5 flex justify-center items-center">
                  <div>
                    <div className='flex '>
                      <h3 className="text-lg font-bold italic">Monitor and Screen Repair:</h3>
                      <div className='w-[80px] border-b-[1px] border-primaryColor mb-[8px] ml-3'></div>
                    </div>
                    <p className="text-gray-600 mt-2">
                      Dealing with a cracked or malfunctioning screen? Our <a href="https://geekify.com.au/services/computer-troubleshooting" className='text-primaryColor underline'>computer screen repair services</a> cover both laptop computer screen repairs and PC screen repair. We assess screen issues and provide
                      affordable, fast fixes, whether it’s replacing a broken laptop screen or addressing monitor issues.
                    </p>
                  </div>
                </div>
              </div>
              <h5 className='text-2xl md:text-2xl lg:text-3xl font-semibold pb-4 pt-3 text-center'>Expert IT Repairs and Troubleshooting</h5>
              <div className="flex flex-col md:flex-row bg-white shadow-md rounded-2xl overflow-hidden">
                <img
                ...
                <div className="p-5 flex justify-center items-center">
                  <div>
                    <div className='flex '>
                      <h3 className="text-lg font-bold italic">On-Site Computer Repair and Home IT Support Service:</h3>
                      <div className='w-[80px] border-b-[1px] border-primaryColor mb-[8px] ml-3'></div>
                    </div>
                    <p className="text-gray-600 mt-2">
                      When you need support at your location, our on site computer repair service is the perfect solution. We’ll come to your home or office, providing convenient <a href="https://geekify.com.au/services/computer-installation-configuration-fixing" className='text-primaryColor underline'>home IT support</a> and ensuring that
                      your devices are set up, secured, and functioning smoothly.
                    </p>
                  </div>
                </div>
              </div>
              <div className="flex flex-col md:flex-row-reverse bg-white shadow-md rounded-2xl overflow-hidden">
                ...
                <div className="p-5 flex justify-center items-center">
                  <div>
                    <div className='flex '>
                      <h3 className="text-lg font-bold italic">Computer Issue Troubleshooting and Diagnostics:</h3>
                      <div className='w-[80px] border-b-[1px] border-primaryColor mb-[8px] ml-3'></div>
                    </div>
                    <p className="text-gray-600 mt-2">
                      Unsure what’s wrong with your device? Our computer troubleshooters are skilled at diagnosing issues and offering solutions. From boot-up issues to unexpected crashes, our technical support
                      team can pinpoint the cause and fix the problem efficiently.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className='container mx-auto pb-8 md:pb-14 lg:pb-20 xl:pb-28'>
        <h5 className='text-2xl md:text-2xl lg:text-3xl font-semibold pt-3 text-center'>Laptop Repairs and Screen Replacements</h5>
        <div className='grid grid-cols-1 md:grid-cols-2 justify-items-center gap-10 pt-5'>
          <div className='shadow-hoverBoxShadow rounded-xl p-6'>
            <Image src='/computer-troubleshooting-icon-1.png' width={200} height={200} alt='' className='w-auto h-auto' />
            <h6 className='text-lg font-bold pt-4 italic'>Laptop and PC Fix Services:</h6>
            <p>
              Laptops are built to be portable, but sometimes their screens, hinges, and keyboards are more prone to damage. Our laptop computer repair services include everything from screen repairs to internal
              hardware replacements. Our customer service ensures you can get back to work quickly.
            </p>
          </div>
          <div className='shadow-hoverBoxShadow rounded-xl p-6'>
            <Image src='/computer-troubleshooting-icon-2.png' width={200} height={200} alt='' className='w-auto h-auto' />
            <h6 className='text-lg font-bold pt-4 italic'>Fix Laptop Issues on Demand:</h6>
            <p>
              Our technicians are equipped to handle common laptop issues like unresponsive screens, broken hinges, or overheating problems. We understand that every laptop is different, and we offer customized
              repair options that are quick and cost-effective.
            </p>
          </div>
        </div>
        <h5 className='text-2xl md:text-2xl lg:text-3xl font-semibold pt-6 lg:pt-10 text-center'>Complete Support for IT Systems and Networks</h5>
        <div className='grid grid-cols-1 md:grid-cols-2 justify-items-center gap-10 pt-5'>
          <div className='shadow-hoverBoxShadow rounded-xl p-6'>
            <Image src='/computer-troubleshooting-icon-3.png' width={200} height={200} alt='' className='w-auto h-auto' />
            <h6 className='text-lg font-bold pt-4 italic'>IT Repairs and Network Setup:</h6>
            <p>
              We understand that businesses and homes rely on seamless IT networks to stay productive and connected. Our IT repair services cover network setup, security assessments, and ongoing maintenance.
              That ensures your network remains fast, secure, and efficient.
            </p>
          </div>
          <div className='shadow-hoverBoxShadow rounded-xl p-6'>
            <Image src='/computer-troubleshooting-icon-4.png' width={200} height={200} alt='' className='w-auto h-auto' />
            <h6 className='text-lg font-bold pt-4 italic'>Home IT Support for Personal Use:</h6>
            <p>
              If you’re working from home or have a family network, our home IT support services can help. We assist with router setup, internet troubleshooting, device connectivity, computer problems, and
              much more. That keeps your home network running smoothly.
            </p>
          </div>
        </div>
        <h5 className='text-2xl md:text-2xl lg:text-3xl font-semibold pt-6 lg:pt-10 text-center'>Computer Help and Support Plans</h5>
        <div className='grid grid-cols-1 md:grid-cols-2 justify-items-center gap-10 pt-5'>
          <div className='shadow-hoverBoxShadow rounded-xl p-6'>
            <Image src='/computer-troubleshooting-icon-5.png' width={200} height={200} alt='' className='w-auto h-auto' />
            <h6 className='text-lg font-bold pt-4 italic'>Regular Maintenance Plans:</h6>
            <p>
              Computers perform better with regular maintenance, which is why we offer remote support plans for ongoing computer help and maintenance services. From cleaning and updates to performance
              optimization, we help you avoid problems before they start.
            </p>
          </div>
          <div className='shadow-hoverBoxShadow rounded-xl p-6'>
            <Image src='/computer-troubleshooting-icon-6.png' width={200} height={200} alt='' className='w-auto h-auto' />
            <h6 className='text-lg font-bold pt-4 italic'>Support for Individuals and Small Businesses:</h6>
            <p>
              Whether you’re a student, remote worker, or business owner, we offer consulting services and support plans to meet your computer services and support needs. Our plans are designed to be affordable
              and flexible. Our remote it support ensures you receive the best care without overspending.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className='container mx-auto py-8 md:py-14 lg:py-20 xl:py-28'>
        ...
        <div className='py-5'>
          <h5 className='text-xl font-bold italic pb-1'>1. Highly Skilled Technicians:</h5>
          <p>
            Our team consists of experienced computer mechanics who are trained to manage a wide range of repair, upgrade, and data recovery service tasks. Each technician brings specialized expertise, whether
            it’s hardware repair, software troubleshooting, or network setup, ensuring you get professional solutions.
          </p>
        </div>
        <div className='pb-5'>
          <h5 className='text-xl font-bold italic pb-1'>2. Latest Tools and Techniques:</h5>
          <p>
            Technology is constantly evolving, and so are we. Our team uses the project management and the latest diagnostic tools and repair techniques to provide fast, effective services. Our computer services
            and support commitment to modern solutions help us address even complex issues efficiently. That keeps your devices in peak condition.
          </p>
        </div>
        <div className='pb-5'>
          <h5 className='text-xl font-bold italic pb-1'>3. On-Site Service for Ultimate Convenience:</h5>
          <p>
            We know that bringing your computer to a repair shop isn’t always feasible. Our on site computer repair service means our experts come directly to you. They provide seamless support at your home or
            office. This service is perfect for those who need immediate help or ongoing home IT support.
          </p>
        </div>
        <div className='pb-5'>
          <h5 className='text-xl font-bold italic pb-1'>4. Quick and Efficient Service:</h5>
          <p>
            We understand that you rely on your computer daily, so we work to minimize downtime. Our quick productivity and turnaround times are a priority. Most repairs are completed within a day or two, and for
            urgent issues, we provide same-day services when possible.
          </p>
        </div>
        <div className='pb-5'>
          <h5 className='text-xl font-bold italic pb-1'>5. Transparent and Affordable Pricing:</h5>
          <p>
            Computer repairs and support don’t have to be expensive. We offer competitive pricing on all tech devices. Our transparent estimates ensure you know exactly what to expect. Our goal is to make quality
            repair and information technology services accessible to everyone without hidden fees.
          </p>
        </div>
        <div className='pb-5'>
          <h5 className='text-xl font-bold italic pb-1'>6. Personalized Solutions for Every Client:</h5>
          <p>
            Every computer and every issue is unique. Our technicians take the time to understand your specific needs and tailor their approach to find the most suitable, cost-effective solution. Whether it’s a
            quick computer equipment fix or a custom IT setup, we personalize our services for the best results.
          </p>
        </div>
        <div className='pb-5'>
          <h5 className='text-xl font-bold italic pb-1'>7. Regular Maintenance Plans for Lasting Performance:</h5>
          <p>
            Prevention is better than cure. Our computer services and support’s regular maintenance plans help you avoid common issues. That keeps your devices performing optimally and extending their lifespan.
            From cleaning to software updates, our operating system services keep your computer running smoothly over time.
          </p>
        </div>
        <div className='pb-5'>
          <h5 className='text-xl font-bold italic pb-1'>8. Proven Expertise in IT Repairs:</h5>
          <p>
            With a track record of successful repairs and satisfied clients, we are trusted for IT repairs and support for network security. Our expertise spans desktops, laptops, monitors, and other hardware.
            That makes us a versatile choice for any tech-related and computer system-related need.
          </p>
        </div>
        <div className='pb-5'>
        ...
        <div className='pb-5'>
          <h5 className='text-xl font-bold italic pb-1'>10. Guaranteed Quality of Service:</h5>
          <p>
            We stand behind the quality of our work with a satisfaction guarantee. If you’re not completely satisfied with our service, we’ll work to make it right with the proactive monitoring system.
            This commitment reflects our dedication to reliability, quality, security, and earning our client's trust every day.
          </p>
        </div>
