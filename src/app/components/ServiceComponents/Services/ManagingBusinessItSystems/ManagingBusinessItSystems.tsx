...
function ManagingBusinessItSystems({service}: ServiceDetailsProps) {
  ...
  return (
    <div>
        ...
        <div>
          ...
          <div className='pt-8 md:pt-14 lg:pt-20 xl:pt-28'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-10 pt-8'>
              ...
              <div className='shadow-hoverBoxShadow rounded-xl p-6'>
                <Image src='/managing-business-icon-2.png' width={200} height={200} alt='' className='w-[80px] h-[80px]' />
                <h6 className='text-lg font-bold pt-4'>Innovation:</h6>
                <p>
                  Technology evolves rapidly, and staying ahead is essential for growth. We consultant job descriptions with the latest advancements in IT. That brings innovative tools and strategies to your
                  business. Whether it’s the newest cybersecurity protocols or advanced data solutions, we keep your business on the cutting edge. So you stay competitive in a fast-paced market for IT company Sydney.
                </p>
              </div>
              <div className='shadow-hoverBoxShadow rounded-xl p-6'>
                <Image src='/managing-business-icon-3.png' width={200} height={200} alt='' className='w-[80px] h-[80px]' />
                <h6 className='text-lg font-bold pt-4'>Customer-Centric Approach:</h6>
                <p>
                  Your business’s unique needs are our priority. We take the time to understand your goals, challenges, and industry-specific requirements. By building custom solutions, we ensure that every IT
                  consultant service we provide aligns with what matters most to you. That enhances productivity and efficiency for Sydney IT consulting firm and business needs.
                </p>
              </div>
              <div className='shadow-hoverBoxShadow rounded-xl p-6'>
              ...
              <div className='shadow-hoverBoxShadow rounded-xl p-6'>
                <Image src='/managing-business-icon-5.png' width={200} height={200} alt='' className='w-[80px] h-[80px]' />
                <h6 className='text-lg font-bold pt-5'>Long-Term Partnership:</h6>
                <p>
                  We see our clients as partners and are dedicated to fostering long-term success. Our Houston IT consulting service role is to support your business’s journey, adapting our solutions as your
                  needs evolve. As your trusted Sydney IT technology consulting, we aim to grow with you, providing guidance, expertise, and a stable IT foundation.1. Best Antivirus Protection For Avast
                </p>
              </div>
            </div>
          </div>
      ...
      <div className='container mx-auto py-8 md:py-14 lg:py-20 xl:py-28'>
        <h3 className='text-2xl md:text-2xl lg:text-4xl font-semibold pb-4 md:pb-7'>Our IT Consulting <span className='text-primaryColor'>Company Services</span></h3>
        <Image src={'/managing-business-1.png'} alt='Best it consultant in Sydney' width={1200} height={900} className='w-full h-auto' />
        <div className='py-8'>
          ...
          <ul className='list-disc ml-7 pt-5 space-y-3'>
            <li><span className='font-bold'>Strategy Development:</span> We craft IT cybersecurity consultant strategies tailored to your specific business objectives, creating a technology roadmap skill.
              That aligns with your growth plans and supports efficient, scalable progress for business consulting services in Australia.
            </li>
            <li><span className='font-bold'>Project Management:</span> Our dedicated team manages every phase of your vendor management projects and consultant jobs from initial planning to
              final implementation. Our expert IT consulting services ensure each step is executed with accuracy to achieve successful, timely results.
            </li>
            <li><span className='font-bold'>Technology Recommendations:</span> By understanding your unique needs, we suggest the most effective strategy consulting solution for your
              business. Our recommendations are designed to help you invest wisely. That enhances performance and delivers maximum value for your IT services Sydney resources.
            </li>

          </ul>
        </div>
        <div className='pb-8'>
          <h5 className='text-2xl font-bold pb-2'>2. Business IT Consulting Services</h5>
          <p>
            Running a business is hard enough without having to worry about IT consultant position issues. Our <a href="https://geekify.com.au/services/managing-business-it-systems" className='text-primaryColor underline'>business technical consultant services</a> in Australia are designed to provide peace of mind. We take a
            personalized approach. That understanding your goals and crafting solutions. That helps your business thrive.
          </p>
          <ul className='list-disc ml-7 pt-5 space-y-3'>
            <li><span className='font-bold'>Custom IT Solutions:</span> We recognize that no two businesses are the same. That’s why we design Houston IT consultant solutions specifically
              for your needs. This ensuring each system enhances your operations and aligns with your goals.
            </li>
            <li><span className='font-bold'>Risk Assessment and Compliance:</span> Our advanced risk management technology solution services help protect your business by identifying potential
              vulnerabilities and ensuring compliance with industry regulations. This proactive approach safeguards your data and keeps you aligned with legal standards for managed IT service.
            </li>
            <li><span className='font-bold'>Cloud Solutions:</span> Our scalable cloud IT services Sydney enable you to streamline daily operations. That enhances collaboration and
              reduces costs. We help you choose the right cloud options, ensuring flexibility and secure access from anywhere.
            </li>

          </ul>
        </div>
        <div>
          <h5 className='text-2xl font-bold pb-2'>3. Specialized IT Services for Sydney Businesses</h5>
          <p>
            With a strong focus on <a href="https://geekify.com.au/book-online" className='text-primaryColor underline'>IT services & cloud consulting</a> for Sydney-based companies, we are familiar with the challenges local businesses face. Our services include:
          </p>
          <ul className='list-disc ml-7 pt-5 space-y-3'>
            <li><span className='font-bold'>Data Protection and Cybersecurity:</span> Safeguarding your data is essential, and our cybersecurity services are tailored to meet the unique needs
              of Australian businesses. We implement robust security measures to protect your information from potential threats.
            </li>
            <li><span className='font-bold'>Managed IT Support:</span> With our managed IT technology consultant support, we handle all technical aspects of your IT infrastructure. That allows
              you to focus on growing your business without worrying about daily IT concerns.
            </li>
            <li><span className='font-bold'>Network Design and Installation:</span> We design and install reliable networks that provide seamless connectivity and strong security for our
              clients. Our solutions ensure your network performs optimally, supporting smooth business operations and secure data exchange.
            </li>
      ...
      <div className='container mx-auto pb-8 md:pb-14 lg:pb-20 xl:pb-28'>
        <div className="">
          <div className=''>
            <h3 className='text-2xl md:text-2xl lg:text-4xl font-semibold pb-4 md:pb-7 text-center'>Consultancy in Sydney with a <span className='text-primaryColor'>Heart for Business Growth</span></h3>
          </div>
          ...
          <div className='space-y-8'>
            <div className="flex flex-col md:flex-row bg-white shadow-md rounded-2xl overflow-hidden">
              ...
              <div className="p-5 flex justify-center items-center">
                <div>
                  <div className='flex '>
                    <h3 className="text-lg font-bold italic">In-depth knowledge of the Sydney IT Landscape</h3>
            ...
            <div className="flex flex-col md:flex-row-reverse bg-white shadow-md rounded-2xl overflow-hidden">
              ...
              <div className="p-5 flex justify-center items-center">
                <div>
                  <div className='flex '>
                    <h3 className="text-lg font-bold italic">Tailored IT Solutions for Businesses of All Sizes</h3>
                    <div className='w-[80px] border-b-[1px] border-primaryColor mb-[8px] ml-3'></div>
                  </div>
                  <p className="text-gray-600 mt-2">
            ...
            <div className="flex flex-col md:flex-row bg-white shadow-md rounded-2xl overflow-hidden">
              ...
              <div className="p-5 flex justify-center items-center">
                <div>
                  <div className='flex '>
                    <h3 className="text-lg font-bold italic">Cost-Effective Access to Expert IT Support</h3>
                    <div className='w-[80px] border-b-[1px] border-primaryColor mb-[8px] ml-3'></div>
                  </div>
                  <p className="text-gray-600 mt-2">
            ...
            <div className="flex flex-col md:flex-row-reverse bg-white shadow-md rounded-2xl overflow-hidden">
              ...
              <div className="p-5 flex justify-center items-center">
                <div>
                  <div className='flex '>
                    <h3 className="text-lg font-bold italic">End-to-end IT Services for Comprehensive Support</h3>
                    <div className='w-[80px] border-b-[1px] border-primaryColor mb-[8px] ml-3'></div>
                  </div>
                  <p className="text-gray-600 mt-2">
            ...
            <div className="flex flex-col md:flex-row bg-white shadow-md rounded-2xl overflow-hidden">
              ...
              <div className="p-5 flex justify-center items-center">
                <div>
                  <div className='flex '>
                    <h3 className="text-lg font-bold italic">Empowering Businesses for Long-Term Success</h3>
                    <div className='w-[80px] border-b-[1px] border-primaryColor mb-[8px] ml-3'></div>
                  </div>
                  <p className="text-gray-600 mt-2">
      ...
      <div className='container mx-auto pb-8 md:pb-14 lg:pb-20 xl:pb-28'>
        ...
        <p className='py-5'>
          We understand the complexities of managing IT, and we make it simple for you. Whether it’s handling everyday technical issues, implementing new systems, or ensuring your cybersecurity is up to date,
      ...
      <div className='container mx-auto pb-8 md:pb-14 lg:pb-20 xl:pb-28'>
        ...
        <div>
          ...
          <p>
            We’ve worked with clients from various sectors, including healthcare, finance, retail, and more. This diversity gives us insight into industry-specific challenges and the expertise to design
            industry-specific solutions.
          </p>
        </div>
        <div className='py-4'>
          <h6 className='text-xl font-bold italic'>2. Proactive Support and 24/7 Availability</h6>
          <p>
            Issues don’t follow a 9-5 schedule, and neither do we. Our team is available 24/7. That ensures you receive assistance whenever you need it.
          </p>
        </div>
        <div>
      ...
      <div className='container mx-auto pt-8 md:pt-14 lg:pt-20 xl:pt-28'>
        <div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-10 mt-12'>
            <div className='shadow-hoverBoxShadow rounded-xl p-6'>
              <div>
                <Image src='/managing-business-icon-6.png' width={100} height={80} alt='' className='w-[50px] h-[50px]' />
              </div>
              <h6 className='font-bold text-xl italic py-4'>Step 1: Initial Discovery Call</h6>
              <p>
                The first step is a discovery call where we take the time to understand your business’s specific IT consultant needs and goals. This is an essential part of the process. It allows us to get to know
                your challenges, objectives, and any existing systems that may need to be improved.
              </p>
            </div>
            <div className='shadow-hoverBoxShadow rounded-xl p-6'>
              <div>
                <Image src='/managing-business-icon-7.png' width={100} height={80} alt='' className='w-[50px] h-[50px]' />
              </div>
              <h6 className='font-bold text-xl italic py-4'>Step 2: Strategy Development</h6>
              <p>
                Once we understand your needs, our team crafts a tailored IT consultant strategy designed to address your business objectives. This strategy outlines the best technology solutions, implementation
                steps, and projected outcomes. That ensures alignment with your goals.
              </p>
            </div>
            <div className='shadow-hoverBoxShadow rounded-xl p-6'>
              <div>
                <Image src='/managing-business-icon-8.png' width={100} height={80} alt='' className='w-[50px] h-[50px]' />
              </div>
              <h6 className='font-bold text-xl italic py-4'>Step 3: Implementation</h6>
              <p>
                With your strategy in place, we proceed to implement the solutions. Our team sets up and configures the systems. We optimize everything and ensure it works seamlessly within your business
                environment.
              </p>
            </div>
            <div className='shadow-hoverBoxShadow rounded-xl p-6'>
              <div>
                <Image src='/managing-business-icon-9.png' width={100} height={80} alt='' className='w-[50px] h-[50px]' />
              </div>
              <h6 className='font-bold text-xl italic py-4'>Step 4: Ongoing Support</h6>
              <p>After the implementation, our commitment doesn’t end. We provide ongoing support, monitoring, and system optimization to ensure your technology continues to serve your business effectively.
                That makes adjustments as needed to accommodate future growth.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='container mx-auto'>
        ...
        <p className='mb-4 pb-4'>
          Ready to elevate your business with tailored IT consulting and services? Contact us today! Fill out our contact form, give us a call, or email us, and our team will respond promptly to answer any
          questions or set up your initial consultation. Let’s work together to make your technology work for you!
        </p>
      </div>
