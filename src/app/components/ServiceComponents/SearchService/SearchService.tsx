        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex justify-center items-center mb-5 xl:mb-[52px]">
            <input
              type="text"
              {...register("search")}
              className="w-[60%] sm:w-[55%] md:w-[50%] lg:w-[40%] xl:w-[30%] py-[6px] px-3 border-[3px] border-primaryColor rounded-l-[10px]  text-[15px] leading-[34px] text-[#20313B] focus:outline-none"
